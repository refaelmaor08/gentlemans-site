...
const trustItems = [
  {
    icon: <MenOnlyIcon />,
    title: "מספרת גברים בלבד",
    desc: "אקסקלוסיביות מוחלטת. המקום הזה בנוי לגברים — האווירה, השירות, והתוצאה.",
  },
  {
    icon: <PrecisionIcon />,
  ...
  {
    icon: <LocationIcon />,
    title: "אווירה יוקרתית בלב תל אביב",
    desc: "דיזנגוף 237 — עיצוב שחור וזהב, אור חם, ריח עץ ועור. מקום שרוצים לחזור אליו.",
  },
];
