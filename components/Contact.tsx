        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className={`space-y-4 transition-all duration-1000 ${visible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-12"}`}>
            ...
            <ContactCard
              icon={<InstagramIcon />}
              title="אינסטגרם"
              main="הצצה לעבודות שלנו"
              link="https://www.instagram.com/gentlemanstlv?igsh=MWhvYzZ3OTlydDl2eQ=="
              linkLabel="עקבו אחרינו"
            />
            ...
            {/* Accessibility note */}
            <div className="card-luxury p-5 rounded-sm border-[#C9A84C]/10">
              <p className="text-[#9A8E7A] text-sm leading-relaxed">
                <span className="text-[#C9A84C] font-semibold">נגישות:</span>{" "}
